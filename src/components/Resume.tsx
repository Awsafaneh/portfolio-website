  ...
  const data = [
      ...
      content: (
        <div>
          <p className="text-neutral-200 text-xs md:text-sm font-normal mb-8">
            ...
            Developer Groups on Campus Haliç. It&apos;s been an incredible journey sharing
            knowledge and inspiring fellow developers through speaking engagements at
            Python101 and Github101 events. Leading project teams has taught me the
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Expanded my horizons through Codecademy&apos;s comprehensive curriculum. Dove
            deep into the fascinating worlds of Data Science and Artificial Intelligence.
            This period marked a significant shift in my understanding of how technology
            can solve complex real-world problems. Each course was a stepping stone toward
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-200 text-xs md:text-sm font-normal mb-8">
            The beginning of my software development journey. Moved to the vibrant city of
            Istanbul to pursue my education at Haliç University. This was more than just a
            change of location - it was the first chapter of my tech story. The university
            environment opened my eyes to the vast possibilities in software development
